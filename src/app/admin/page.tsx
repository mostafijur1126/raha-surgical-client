...
export default function AdminLoginPage() {
  ...
  // A pulsing "heartbeat monitor" line — ties to the clinical brand instead
  if (!mounted) {
    return (
      <main
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm mt-0.5" style={{ color: textSecondary }}>
              Secure Clinical Management Access
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                placeholder="dr.smith@rahasurgical.com"
          ...
          >
            <div className="flex items-start gap-2">
              <input
                ...
                className="w-4 h-4 rounded border-2 focus:ring-2 focus:ring-offset-0 transition-colors mt-0.5"
                style={{
                  accentColor: primaryColor,
                  borderColor: inputBorder,
                }}
              ...
              >
                ...
                <span className="text-xs" style={{ color: textMuted }}>
                  A push notification will be sent to your verified device.
                </span>
              </label>
            </div>
          </div>
          ...
          >
            <p className="text-xs" style={{ color: textMuted }}>
              &copy; {new Date().getFullYear()} RAHA Surgical Equipment.
              Clinical Excellence &amp; Security.
            </p>
          </div>
        </div>
      </div>
